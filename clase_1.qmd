...
Los [reportes parametrizados](https://posit.co/blog/parameterized-quarto/) nos permiten cambiar aspectos del código del documento al cambiar una variable definida en el encabezado del mismo. 
...
::: {.aside}
(Este ejemplo se encuentra en el [repositorio del curso,](https://github.com/bastianolea/curso_intro_R_nivel4_spatialLab) carpeta `quarto_reportes`, archivo `iris_params.qmd`) 
:::
